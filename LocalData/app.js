let btn1 = document.querySelector(".pop");
let btn2 = document.querySelector(".lan");
...
btn1.addEventListener("click", function () {
  ...
  populate.style.display = "flex";
  let countries = countries_data
    .sort((a, b) => b.population - a.population)
    .slice(0, 10)
    .forEach((element) => {
      let text1 = document.createElement("p");
      text1.innerText = element.name;
      city.appendChild(text1);
      //   console.log(element.name);

      let text2 = document.createElement("p");
      text2.innerText = element.population;
      cem.appendChild(text2);
    });
});
...
btn2.addEventListener("click", function () {
  city.innerHTML = " ";
  cem.innerHTML = " ";
  spoken.style.display = "flex";
  populate.style.display = "none";

  let areas = countries_data
    .sort((a, b) => b.area - a.area)
    .slice(0, 10)
    .forEach((element) => {
      let text11 = document.createElement("p");
      text11.innerText = element.name;
      city.appendChild(text11);
      //   console.log(element.name);

      let text22 = document.createElement("p");
      text22.innerText = element.population;
      cem.appendChild(text22);
    });
});
